...
export default function Admin() {
    return (
        <div className="admin min-h-screen mt-0 pt-4">
            <Header/>
            <div className="max-w-md w-full mx-auto mt-20 mb-0 bg-white  p-8 border rounded-md text-center shadow-lg">
                <LuUsers className="mx-auto text-[#009951]" style={{width: '5vw', height: 'auto'}}/>

                <h3 className="font-normal text-2xl sm:text-3xl py-4">ADMIN LOGIN</h3>
